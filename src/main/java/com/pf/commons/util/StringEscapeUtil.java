...
/**
 *
 * Description: 字符串转义工具类，能将字符串转换成适应 Java、Java Script、HTML、XML、和SQL语句的形式。
 * StringEscapeUtil.java Create on  2013年8月23日 下午6:07:30 
 * @author
 * @version 1.0
 * Copyright (c) 2013 T.b.j,Inc. All Rights Reserved.
 */
